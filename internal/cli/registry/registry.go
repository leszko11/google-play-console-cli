...
import (
	...
	"github.com/leszko11/google-play-console-cli/internal/cli/customapps"
	...
	"github.com/leszko11/google-play-console-cli/internal/cli/watch"
...
func Register(root *ffcli.Command, deps Deps) {
	...
	root.Subcommands = []*ffcli.Command{
		...
		customapps.NewCommand(customapps.Deps{}),
		...
		screenshots.NewCommand(screenshots.Deps{}),
